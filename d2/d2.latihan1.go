...
Continue:
Tantangan: Sistem Loyalty Points & Voucher Cashback
*/
...
CheckoutProcessing:
	...
	poin := (int(math.Floor(totalBelanja)) % 100_000) * 10
	var voucher float64
	switch {
	case totalBelanja > 20_000_000:
		voucher = 1_000_000.0
	case totalBelanja > 5_000_000:
		voucher = 200_000.0
	default:
		voucher = 0
	}

	fmt.Printf("Poin: %d, Voucher Cashback: Rp %.2f", poin, voucher)
